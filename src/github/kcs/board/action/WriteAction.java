...
/*
 * 
------WebKitFormBoundarytUOlBCbTZKB35fD8
...
asdfasdfasdfds
------WebKitFormBoundarytUOlBCbTZKB35fD8
Content-Disposition: form-data; name="f"; filename="chrome_elf.dll"
...
public class WriteAction implements IAction {
    ...
    public String proccess(BoardContext btx, HttpServletRequest req, HttpServletResponse res)
        ...
        */
        ...
        PostVO pd = new PostVO(null, title, content, 0, null, loginUser, new CodeVO(categoryFK, null));
        pd.setAttachedFile(file);
        postDao.insertPost (  pd );
